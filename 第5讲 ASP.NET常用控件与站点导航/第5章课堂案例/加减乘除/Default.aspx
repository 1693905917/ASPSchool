    ...
    <div>
        <table style="width: 397px">
            <tr>
                ...
                <td style="width: 4px">
                    <asp:Button ID="btnAdd" runat="server" Text="＋" Font-Size="Larger" OnClick="Button_Click"  /></td>
            ...
            <tr>
                <td style="width: 4px">
                    <asp:Button ID="btnSub" runat="server" Text="－" Font-Size="Larger" OnClick="Button_Click" /></td>
            </tr>
            <tr>
                <td style="width: 4px">
                    <asp:Button ID="btnMulti" runat="server" Text="×" Font-Size="Larger" OnClick="Button_Click" /></td>
            </tr>
            <tr>
                <td style="width: 4px">
                    <asp:Button ID="btnDivi" runat="server" Text="÷" Font-Size="Larger"  OnClick="Button_Click"/></td>
            </tr>
        </table>
