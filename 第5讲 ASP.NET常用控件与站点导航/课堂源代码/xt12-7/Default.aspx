...
<body>
    ...
    <div>
        ...
        <asp:Login ID="Login1" runat="server" DestinationPageUrl="~/Welcome.aspx" 
            PasswordRecoveryText="忘记密码？" PasswordRecoveryUrl="~/PasswordRecovery.aspx" 
            CreateUserText="新用户注册" CreateUserUrl="~/Register.aspx">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <asp:HyperLink ID="PasswordRecoveryLink" runat="server" 
                                            NavigateUrl="~/PasswordRecovery.aspx">忘记密码？</asp:HyperLink>
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:HyperLink ID="CreateUserLink" runat="server" NavigateUrl="~/Register.aspx">新用户注册</asp:HyperLink>
                                        <br />
                                    </td>
                                </tr>
                            </table>
